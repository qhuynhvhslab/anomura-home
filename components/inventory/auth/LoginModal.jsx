...
const LoginModal = ({ isMobile, closeModal }) => {
    ...
    // const handleSignin = async (typeOf) => {
    //     if (typeOf === Enums.METAMASK) {
    //         console.log(123);
    ...
    return (
        <div className={s.loginModal_card}>
            {/* <div className={s.loginModal_wrapper}>
                {!isMobile && (
                    <div
                        className={s.loginModal_container}
                        onClick={() => {
                            handleSignin(Enums.METAMASK);
                        }}
                    >
                        <div className={s.loginModal_providerIcon}>
                            <img
                        ...
                        <div className={s.loginModal_providerName}>Metamask</div>
                    </div>
                )}
            </div>
            ...
            <div className={s.loginModal_wrapper}>
                <div
                    className={s.loginModal_container}
                    onClick={() => {
                        handleSignin(Enums.WALLETCONNECT);
                    }}
                >
                    <div className={s.loginModal_providerIcon}>
                        <img
                    ...
                    <div className={s.loginModal_providerName}>WalletConnect</div>
                </div>
            </div> */}
        </div>
    );
